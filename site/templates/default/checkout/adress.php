                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="firma_name" id="firma_name"
                            value="<?php print $this->user->firma_name?>"
                ...
                <div class="control-group" id='tr_field_firma_code'
                    ...
                    <div class="controls">
                        <input type="text" name="firma_code" id="firma_code"
                            value="<?php print $this->user->firma_code?>"
                ...
                <div class="control-group" id='tr_field_tax_number'
                    ...
                    <div class="controls">
                        <input type="text" name="tax_number" id="tax_number"
                            value="<?php print $this->user->tax_number?>"
            ...
            <div class="control-group box_button">
                <div class="controls">
                    ...
                    <input type="submit" class="btn btn-success" name="next"
                        value="<?php print JText::_('JSHOP_NEXT')?>" class="btn btn-primary button" />
                </div>
            </div>
        </form>
    </div>
