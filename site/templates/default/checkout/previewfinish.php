    ...
    <div class="jshop checkout_pfinish_block">
        ...
        <div class="checkoutinfo">
            <div class="bill_address">
               <strong><?php print Text::_('JSHOP_BILL_ADDRESS')?></strong>:
               <span>
            ...
            <?php if ($this->count_filed_delivery){?>
                <div class="delivery_address">
                   <strong><?php print Text::_('JSHOP_FINISH_DELIVERY_ADRESS')?></strong>: 
                   <span>
            ...
            <?php if (!$this->config->without_shipping){?>  
                <div class="shipping_info">
                    <strong><?php print Text::_('JSHOP_FINISH_SHIPPING_METHOD')?></strong>: 
                    <span><?php print $this->sh_method->name?></span>
                    <?php if ($this->delivery_time){?>
                        <div class="delivery_time"><strong><?php print Text::_('JSHOP_DELIVERY_TIME')?></strong>: 
                        <span><?php print $this->delivery_time?></span></div>
                    <?php }?>
                    <?php if ($this->delivery_date){?>
                        <div class="delivery_date"><strong><?php print Text::_('JSHOP_DELIVERY_DATE')?></strong>: 
            ...
            <?php if (!$this->config->without_payment){?>  
                <div class="payment_info">
                   <strong><?php print Text::_('JSHOP_FINISH_PAYMENT_METHOD')?></strong>: <span><?php print $this->payment_name ?></span>
                </div>
            <?php } ?>
        </div>
        ...
        <form name="form_finish" action="<?php print $this->action ?>" method="post" <?php if ($this->config->checkout_form_finish_multipart) {?>enctype="multipart/form-data"<?php }?>>
            <div class="pfinish_comment_block">             
                ...
                <div class="box_button"> 
                    ...
                    <input class="btn btn-success button" id="previewfinish_btn" type="submit" name="finish_registration" value="<?php print Text::_('JSHOP_ORDER_FINISH')?>" data-agb="<?php echo $this->config->display_agb;?>" data-noreturn="<?php echo $this->no_return?>">
                </div>
            </div> 
