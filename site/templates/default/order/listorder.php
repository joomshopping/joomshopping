...
<div class="jshop myorders_list" id="comjshop">
    ...
    <?php if (count($this->orders)) {?>
                ...
                <div class="table_order_list">
                    <div class="row">
                        <div class="col-lg-6 users">
                            ...
                            <div>
                                <b><?php print Text::_('JSHOP_EMAIL_BILL_TO')?>:</b>
                                <span><?php print $order->f_name ?> <?php print $order->l_name ?></span>
                            </div>
                            <div>
                                <b><?php print Text::_('JSHOP_EMAIL_SHIP_TO')?>:</b>
                        ...
                        <div class="col-lg-3 products">
                            <div>
                                <b><?php print Text::_('JSHOP_PRODUCTS')?>:</b> 
                        ...
                        <div class="col-lg-3 buttons">
                            <a class="btn btn-primary" href="<?php print $order->order_href ?>"><?php print Text::_('JSHOP_DETAILS')?></a>
        ...
        <div class="myorders_total">
            ...
            <span class="price"><?php print Helper::formatprice($this->total, Helper::getMainCurrencyCode())?></span>
        </div>
