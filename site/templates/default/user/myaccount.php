...
<div class="jshop" id="comjshop">
    ...
    <div class="myaccount_urls">
        <div class="editdata">
            <a href = "<?php print $this->href_edit_data?>"><?php print Text::_('JSHOP_EDIT_DATA')?></a>
        </div>
        <div class="showorders">
            <a href = "<?php print $this->href_show_orders?>"><?php print Text::_('JSHOP_SHOW_ORDERS')?></a>
        </div>
	    <?php echo $this->tmpl_my_account_html_content?>
        <div class="urllogout">
            <a href = "<?php print $this->href_logout?>"><?php print Text::_('JSHOP_LOGOUT')?></a>
        </div>
    </div>
