...
class JshoppingmanufacturersField extends ListField
{
	protected $type = 'jshoppingmanufacturers';
	...
	{		
		...
		foreach ($list as $item) {
			$options[] = HTMLHelper::_('select.option', $item->manufacturer_id, $item->name);
		}
		return $options;
	}
}