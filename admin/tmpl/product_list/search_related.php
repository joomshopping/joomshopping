...
$start=intval(Factory::getApplication()->input->getInt("start")/$this->limit)+1;
...
<div class="block_related" id="serched_product_<?php print $row->product_id;?>">
    <div class="block_related_inner">
        ...
        <div class="image">
            ...
            <?php } else { ?>
                <img src="<?php print Helper::getPatchProductImage($this->config->noimage, '', 1)?>" width="90" border="0" />
            <?php } ?>
            </a>
        ...
        <div style="padding-top:5px;"><input type="button" class="btn btn-small btn-success" value="<?php print Text::_('JSHOP_ADD')?>" onclick="jshopAdmin.add_to_list_relatad(<?php print $row->product_id;?>)"></div>
    </div>
</div>
<?php
}
