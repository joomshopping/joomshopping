    ...
    <form action="index.php?option=com_jshopping&controller=products" method="post" name="adminForm" id="adminForm">
        ...
        <table class="table table-striped">
            ...
            <tbody <?php if ($saveOrder) :?> class="js-draggable" data-url="<?php echo $saveOrderingUrl; ?>"
                ...
                <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1" item-id="<?php echo $row->product_id; ?>"
                    parents="" level="1">
                    ...
                    <td>
                        <b><a
                                href="index.php?option=com_jshopping&controller=products&task=edit&product_id=<?php print $row->product_id?>"><?php echo $row->name;?></a></b>
