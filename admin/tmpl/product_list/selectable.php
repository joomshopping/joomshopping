...
<form action="index.php?option=com_jshopping&controller=product_list_selectable&tmpl=component" method="post"
    ...
    <table class="table table-striped">
        ...
        <tr class="row<?php echo $i % 2;?>">
            ...
            <td>
                <b><a href="#"
                        onclick="window.parent.<?php print $jsfname?>(<?php echo $row->product_id; ?>)"><?php echo $row->name;?></a></b>
