...
<div id="product_images_tab" class="tab-pane <?php if ($this->product->parent_id!=0){?>active<?php }?>">
    ...
    ?>          
        <div class="product_image_list_item" id="foto_product_<?php print $image->image_id?>">
            <div class="mb-1"><input type="text" class="form-control middle2" name="old_image_descr[<?php print $image->image_id?>]" placeholder="<?php print JText::_('JSHOP_IMG_ALT')?>" title="<?php print JText::_('JSHOP_IMG_ALT')?>" value="<?php print htmlspecialchars($image->name);?>" ></div>
            <?php if ($jshopConfig->product_img_seo) {?>
            <div class="mb-1"><input type="text" class="form-control middle2" name="old_image_title[<?php print $image->image_id?>]" placeholder="<?php print JText::_('JSHOP_TITLE')?>" title="<?php print JText::_('JSHOP_TITLE')?>" value="<?php print htmlspecialchars($image->title);?>" ></div>
            <div class="mb-1"><input type="text" class="form-control middle2" name="old_image_name[<?php print $image->image_id?>]" placeholder="<?php print JText::_('JSHOP_IMG_NAME')?>" title="<?php print JText::_('JSHOP_IMG_NAME')?>"></div>
            <?php } ?>
