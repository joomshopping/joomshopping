...
?>
<form action="index.php?option=com_jshopping&controller=productimages&task=videos&tmpl=component" method="post">
		...
		<?php foreach ($this->list as $file): ?>
            <div class="col">
                <div class="card border border-secondary h-100">
                    <div class="card-body">
                        <a href="#" onclick="parent.jshopAdmin.setVideoFromFolder('<?php echo $file?>');return false;">
                            <?php echo $file?>
                        </a>
                    </div>
                </div>
