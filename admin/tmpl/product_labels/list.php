...
<?php foreach($rows as $row){ ?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
    <?php if ($row->image){?>
        <img class="productlabels" src="<?php echo $this->config->image_labels_live_path."/".$row->image?>" alt=""/>
    <?php }?>
   </td>
	<td class="center">
		<a class="btn btn-micro btn-nopad"  href='index.php?option=com_jshopping&controller=productlabels&task=edit&id=<?php print $row->id;?>'>
            <i class="icon-edit"></i>
        </a>
	</td>
    <td class="center">
