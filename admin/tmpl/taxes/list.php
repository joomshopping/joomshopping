...
<thead>
  <tr>
    ...
    <th align="left">
      <?php echo \JHTML::_('grid.sort', JText::_('JSHOP_TITLE'), 'tax_name', $this->filter_order_Dir, $this->filter_order); ?>
    </th>
    <th width="200">
        <?php echo JText::_('JSHOP_EXTENDED_RULE_TAX')?>
    </th>
    <th width="50" class="center">
        <?php echo JText::_('JSHOP_EDIT')?>
    </th>
    <th width="40" class="center">
        <?php echo \JHTML::_('grid.sort', JText::_('JSHOP_ID'), 'tax_id', $this->filter_order_Dir, $this->filter_order); ?>
    </th>
  </tr>
</thead>  
